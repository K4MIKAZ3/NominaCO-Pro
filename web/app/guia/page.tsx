...
export const metadata: Metadata = {
  ...
  description:
    "Artículos sobre liquidación quincenal, recargo nocturno, auxilio de transporte, descuentos y prestaciones sociales en Colombia.",
  alternates: {
  ...
  openGraph: {
    ...
    description:
      "Aprende a calcular tu liquidación y entender descuentos legales en Colombia.",
    ...
    <main className="page-main">
      <div className="container">
        <div className="section-title blog-index-header">
          ...
          <p>
            Artículos claros sobre liquidación, recargos y prestaciones en
            Colombia. Herramientas útiles si buscas entender tu pago antes de
            descargar {site.name}.
          </p>
        </div>
